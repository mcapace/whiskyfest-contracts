...
export const ROSTER_UI_COLUMNS: RosterColumnDef[] = [
  ...
  { id: 'licenseStatus', label: 'License status', essential: true, extended: true, minWidth: '10rem' },
  { id: 'licenseFee', label: 'License fee', essential: true, extended: true, minWidth: '7.5rem' },
