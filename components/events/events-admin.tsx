...
function emptyForm(opts: { wineSpectatorOnly?: boolean; bigSmokePortal?: boolean } = {}) {
  ...
  return {
    ...
    shanken_signatory_name: 'Nicole Mazza',
    shanken_signatory_title: opts.wineSpectatorOnly ? 'Sr. Director of Events' : 'Event Director',
    shanken_signatory_email: opts.wineSpectatorOnly ? 'snolan@mshanken.com' : 'nmazza@mshanken.com',
    is_active: true,
    product_key: opts.wineSpectatorOnly ? 'wine_spectator' : 'whiskyfest',
